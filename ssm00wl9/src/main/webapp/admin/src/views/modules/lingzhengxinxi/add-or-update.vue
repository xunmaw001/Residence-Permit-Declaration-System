          ...
          <el-form-item class="input" label="用户账号" prop="yonghuzhanghao">
              <el-input v-model="ruleForm.yonghuzhanghao" 
                placeholder="用户账号" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="真实姓名" prop="zhenshixingming">
          <el-input v-model="ruleForm.zhenshixingming" 
              placeholder="真实姓名" clearable  :readonly="ro.zhenshixingming"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="真实姓名" prop="zhenshixingming">
              <el-input v-model="ruleForm.zhenshixingming" 
                placeholder="真实姓名" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="申报时间" prop="shenbaoshijian">
          <el-input v-model="ruleForm.shenbaoshijian" 
              placeholder="申报时间" clearable  :readonly="ro.shenbaoshijian"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="申报时间" prop="shenbaoshijian">
              <el-input v-model="ruleForm.shenbaoshijian" 
                placeholder="申报时间" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="领证时间" prop="lingzhengshijian">
            <el-date-picker
                value-format="yyyy-MM-dd HH:mm:ss"
                v-model="ruleForm.lingzhengshijian" 
                type="datetime"
                placeholder="领证时间">
            </el-date-picker>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.lingzhengshijian" label="领证时间" prop="lingzhengshijian">
              <el-input v-model="ruleForm.lingzhengshijian" 
                placeholder="领证时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="领证地点" prop="lingzhengdidian">
          <el-input v-model="ruleForm.lingzhengdidian" 
              placeholder="领证地点" clearable  :readonly="ro.lingzhengdidian"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="领证地点" prop="lingzhengdidian">
              <el-input v-model="ruleForm.lingzhengdidian" 
                placeholder="领证地点" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="说明" prop="shuoming">
          <el-input v-model="ruleForm.shuoming" 
              placeholder="说明" clearable  :readonly="ro.shuoming"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="说明" prop="shuoming">
              <el-input v-model="ruleForm.shuoming" 
                placeholder="说明" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
          ...
          <el-form-item class="input" label="工号" prop="gonghao">
              <el-input v-model="ruleForm.gonghao" 
                placeholder="工号" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="警察姓名" prop="jingchaxingming">
          <el-input v-model="ruleForm.jingchaxingming" 
              placeholder="警察姓名" clearable  :readonly="ro.jingchaxingming"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="警察姓名" prop="jingchaxingming">
              <el-input v-model="ruleForm.jingchaxingming" 
                placeholder="警察姓名" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                                            </el-row>
...
export default {
  ...
  methods: {
        ...
        if (data && data.code === 0) {
          var json = data.data;
              		...
              		this.ruleForm.gonghao = json.gonghao
                                  		...
                                  		if(json.jingchaxingming!=''&&json.jingchaxingming){
              		this.ruleForm.jingchaxingming = json.jingchaxingming
		}
                                                    } else {
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `lingzhengxinxi/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.lingzhengxinxiCrossAddOrUpdateFlag = false;
                  this.parent.search();
