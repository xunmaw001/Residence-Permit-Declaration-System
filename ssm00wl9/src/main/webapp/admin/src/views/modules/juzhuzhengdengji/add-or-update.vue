<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
                        <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'" label="申报编号" prop="shenbaobianhao">
            <el-input v-model="ruleForm.shenbaobianhao" 
                placeholder="申报编号" readonly></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.shenbaobianhao" label="申报编号" prop="shenbaobianhao">
              <el-input v-model="ruleForm.shenbaobianhao" 
                placeholder="申报编号" readonly></el-input>
          </el-form-item>
        </div>
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.zhaopian" label="照片" prop="zhaopian">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.zhaopian.split(',')" :src="item" width="100" height="100">
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="所在户籍" prop="suozaihuji">
          <el-input v-model="ruleForm.suozaihuji" 
              placeholder="所在户籍" clearable  :readonly="ro.suozaihuji"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="所在户籍" prop="suozaihuji">
              <el-input v-model="ruleForm.suozaihuji" 
                placeholder="所在户籍" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="政治面貌" prop="zhengzhimianmao">
          <el-input v-model="ruleForm.zhengzhimianmao" 
              placeholder="政治面貌" clearable  :readonly="ro.zhengzhimianmao"></el-input>
        </el-form-item>
        <div v-else>
          ...
          <el-form-item class="input" label="联系电话" prop="lianxidianhua">
              <el-input v-model="ruleForm.lianxidianhua" 
                placeholder="联系电话" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="户主" prop="huzhu">
          <el-select v-model="ruleForm.huzhu" placeholder="请选择户主">
            <el-option
                v-for="(item,index) in huzhuOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="户主" prop="huzhu">
	      <el-input v-model="ruleForm.huzhu"
                placeholder="户主" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="与户主关系" prop="yuhuzhuguanxi">
          <el-input v-model="ruleForm.yuhuzhuguanxi" 
              placeholder="与户主关系" clearable  :readonly="ro.yuhuzhuguanxi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="与户主关系" prop="yuhuzhuguanxi">
              <el-input v-model="ruleForm.yuhuzhuguanxi" 
                placeholder="与户主关系" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="申报时间" prop="shenbaoshijian">
            <el-date-picker
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.shenbaoshijian" label="申报时间" prop="shenbaoshijian">
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          	            if(o=='shenbaobianhao'){
            this.ruleForm.shenbaobianhao = obj[o];
	    this.ro.shenbaobianhao = true;
            continue;
          }
	            	            if(o=='yonghuzhanghao'){
	    ...
	    this.ro.zhaopian = true;
            continue;
	            	            ...
	            	            if(o=='suozaihuji'){
            this.ruleForm.suozaihuji = obj[o];
	    this.ro.suozaihuji = true;
            continue;
          }
	    ...
	    this.ro.huzhu = true;
            continue;
	            	            ...
	            	            if(o=='yuhuzhuguanxi'){
            this.ruleForm.yuhuzhuguanxi = obj[o];
	    this.ro.yuhuzhuguanxi = true;
            continue;
          }
	            	            if(o=='shenbaoshijian'){
        ...
        if (data && data.code === 0) {
          var json = data.data;
              		...
              		this.ruleForm.yonghuzhanghao = json.yonghuzhanghao
                                  		...
                                  		if(json.zhenshixingming!=''&&json.zhenshixingming){
              		this.ruleForm.zhenshixingming = json.zhenshixingming
		}
          ...
          this.$message.error(data.msg);
                                                                                                                                                                                                                                                                  ...
                                                                                                                                                                                                                                                                  this.huzhuOptions = "否,是".split(',')
                                                                                                                      },
                                                                                                                                                        // 多级联动参数
                                                                                                                                                                                                info(id) {
      this.$http({
        url: `juzhuzhengdengji/info/${id}`,
        method: "get"
      }).then(({ data }) => {
        if (data && data.code === 0) {
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `juzhuzhengdengji/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.juzhuzhengdengjiCrossAddOrUpdateFlag = false;
                  this.parent.search();
