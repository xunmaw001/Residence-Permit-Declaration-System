	...
	export default {
		...
		async onLoad(options) {
			...
			if (options.id) {
				...
				// 获取信息
				res = await this.$api.info(`discussgonggaolan`, this.ruleForm.id);
		...
		methods: {
			...
			async onSubmitTap() {
					...
					return
																																																																				...
																																																																				if(this.ruleForm.id){
					await this.$api.update(`discussgonggaolan`, this.ruleForm);
				}else{
					await this.$api.add(`discussgonggaolan`, this.ruleForm);
				}
