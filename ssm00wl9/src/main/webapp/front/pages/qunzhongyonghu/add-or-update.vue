	...
	export default {
		...
		async onLoad(options) {
			...
			if (options.id) {
				...
				// 获取信息
				res = await this.$api.info(`qunzhongyonghu`, this.ruleForm.id);
		...
		methods: {
			...
			async onSubmitTap() {
					...
					return
																																																																...
																																																																if(this.ruleForm.id){
					await this.$api.update(`qunzhongyonghu`, this.ruleForm);
				}else{
					await this.$api.add(`qunzhongyonghu`, this.ruleForm);
				}
